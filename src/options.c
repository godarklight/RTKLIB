...
EXPORT opt_t sysopts[]={
    ...
    {"pos2-arthres",    1,  (void *)&prcopt_.thresar[0], "Ratio to fix"     },
    {"pos2-arthres1",   1,  (void *)&prcopt_.thresar[1], "AR filter convergance distance"     },
    {"pos2-arthres2",   1,  (void *)&prcopt_.thresar[2], ""     },
    {"pos2-arthres3",   1,  (void *)&prcopt_.thresar[3], ""     },
    {"pos2-arthres4",   1,  (void *)&prcopt_.thresar[4], ""     },
    {"pos2-arthres5",   1,  (void *)&prcopt_.thresar[5], "AR filter drop to reject bad satellite (0-1)"     },
    {"pos2-varholdamb", 1,  (void *)&prcopt_.varholdamb, "cyc^2"},
    {"pos2-gainholdamb",1,  (void *)&prcopt_.gainholdamb,""     },
    {"pos2-arlockcnt",  0,  (void *)&prcopt_.minlock,    "Sample count to set bias"     },
    {"pos2-minfixsats", 0,  (void *)&prcopt_.minfixsats, "Minimum number of satellites to fix ambiguities"     },
    {"pos2-minholdsats",0,  (void *)&prcopt_.minholdsats,"Minimum number of satellites to hold ambiguities"     },
    {"pos2-mindropsats",0,  (void *)&prcopt_.mindropsats,"Minimum number of satellites to enable drop algorithm"     },
    {"pos2-rcvstds",    3,  (void *)&prcopt_.rcvstds,    SWTOPT },
    {"pos2-arelmask",   1,  (void *)&elmaskar_,          "deg"  },
    {"pos2-arminfix",   0,  (void *)&prcopt_.minfix,     "Sample count to hold set bias"     },
    {"pos2-armaxiter",  0,  (void *)&prcopt_.armaxiter,  "Max iteration to resolve ambiguity"     },
    {"pos2-elmaskhold", 1,  (void *)&elmaskhold_,        "deg"  },
    {"pos2-aroutcnt",   0,  (void *)&prcopt_.maxout,     "Sample outage count to reset bias"     },
    {"pos2-maxage",     1,  (void *)&prcopt_.maxtdiff,   "s"    },
    {"pos2-syncsol",    3,  (void *)&prcopt_.syncsol,    SWTOPT },
    {"pos2-slipthres",  1,  (void *)&prcopt_.thresslip,  "Slip threshold of geometry-free phase (m)"    },
    {"pos2-rejionnoc",   1,  (void *)&prcopt_.maxinnoc,    "Reject threshold of innovation code (m)"    },
    {"pos2-rejionnop",   1,  (void *)&prcopt_.maxinnop,    "Reject threshold of innovation phase (m)"    },
    {"pos2-rejgdop",    1,  (void *)&prcopt_.maxgdop,    "Reject threshold of gdop"     },
    {"pos2-niter",      0,  (void *)&prcopt_.niter,      "Number of filter iteration"     },
